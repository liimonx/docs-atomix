  ...
  const examples = [
    {
      title: "Landing Page",
      description:
        "A modern, responsive landing page with various sections and components",
    ...
    <div className="u-container u-pt-10 u-pb-16">
      ...
      <div className="u-row">
        {examples.map((example, index) => (
          <div
            key={index}
            className={`u-col-${example.featured ? "12" : "12"} u-col-md-${
              example.featured ? "12" : "6"
            } u-col-lg-${example.featured ? "12" : "4"} u-mb-6`}
          >
