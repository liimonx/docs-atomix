  ...
  const features = [
    {
      ...
      description: "Built with performance in mind, ensuring the fastest experience for your users."
    },
    {
      icon: <Icon name="Lock" />,
    ...
    },
    {
      ...
      description: "Tailor every aspect of the application to match your unique business needs."
    },
    {
    ...
    },
    {
      ...
      description: "Connect with your favorite tools and services through our API."
    }
  ];
  ...
  const testimonials = [
    {
      ...
      quote: "This platform transformed how we work. The efficiency gains have been remarkable.",
      avatar: "AJ"
    },
    {
      name: "Sarah Williams",
      role: "Product Manager",
      quote: "Intuitive interface and powerful features. It's a game-changer for our team.",
      avatar: "SW"
    },
    {
      name: "Michael Chen",
  ...
  const pricingPlans = [
    {
      ...
      features: ["Up to 5 projects", "Basic analytics", "Email support", "Standard components"],
      popular: false
    },
    {
      title: "Professional",
      ...
      features: ["Unlimited projects", "Advanced analytics", "Priority support", "Premium components", "Custom branding"],
      popular: true
    },
    {
      title: "Enterprise",
      ...
      features: ["Unlimited projects", "Advanced analytics", "24/7 dedicated support", "Premium components", "Custom branding", "API access", "Single sign-on"],
      popular: false
    }
  ];
    ...
    <HomePageLayout>
      ...
      <Block>
          <SectionIntro
            ...
            alignment="center"
          />
          <div className="u-d-flex u-flex-column u-gap-4 u-mt-8">
            {[
            ...
            {testimonials.map((testimonial, index) => (
              <GridCol key={index} md={4} className="u-mb-6">
                <Card 
                  ...
                  icon={
                    <div className="u-d-flex u-align-items-center u-justify-content-center u-rounded-circle u-bg-primary u-text-white u-w-10 u-h-10 u-mb-3">
                      {testimonial.avatar}
                    </div>
                  }
                  className="u-h-100"
      ...
      <Block>
          <SectionIntro
            ...
            alignment="center"
          />
          <div className="u-d-grid u-grid-cols-1 u-gap-6 md:u-grid-cols-3">
            <div className="u-p-4 u-bg-primary-1 u-br-lg u-border u-border-border">
              <h3 className="u-fs-xl u-fw-bold u-mb-3 u-text-primary">Advanced Analytics</h3>
              <p className="u-text-secondary-emphasis u-mb-4">
                Monitor your business metrics in real-time with our comprehensive analytics suite.
              </p>
            ...
            <div className="u-p-4 u-bg-success-1 u-br-lg u-border u-border-border">
              <h3 className="u-fs-xl u-fw-bold u-mb-3 u-text-success">Enterprise Security</h3>
              <p className="u-text-secondary-emphasis u-mb-4">
            ...
            <div className="u-p-4 u-bg-warning-1 u-br-lg u-border u-border-border">
              <h3 className="u-fs-xl u-fw-bold u-mb-3 u-text-warning">Seamless Integrations</h3>
              <p className="u-text-secondary-emphasis u-mb-4">
                Connect with over 200+ popular apps and services to streamline your workflow.
              </p>
              <div className="u-d-grid u-grid-cols-2 u-gap-2">
            ...
            {pricingPlans.map((plan, index) => (
              <GridCol key={index} md={4} className="u-mb-6">
                ...
                <Card 
                  ...
                  className={`u-h-100 ${plan.popular ? 'u-border-2 u-border-primary' : ''}`}
                >
                  <div className="u-mb-4">
                    <span className="u-fs-4xl u-fw-bold u-text-primary">{plan.price}</span>
                    <span className="u-text-secondary-emphasis">/{plan.period}</span>
                  </div>
                  <ul className="u-list-unstyled u-mb-4">
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="u-d-flex u-align-items-center u-mb-2">
                        <Icon name="Check" className="u-text-success u-me-2" /> {feature}
                      </li>
                    ))}
                  </ul>
                  <Button 
          ...
          <div className="u-mt-8">
            {faqs.map((faq, index) => (
              <div key={index} className="u-mb-4">
                <h4 className="u-fs-lg u-fw-semibold u-mb-2 u-text-primary">{faq.question}</h4>
      ...
      <Block>
          ...
          >
            Our team of experts can help you build a tailored solution that fits your unique business requirements.
          </Callout>
      </Block>
    </HomePageLayout>
  );
