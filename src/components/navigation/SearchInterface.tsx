            ...
            {searchTerm ? (
              filteredResults.length > 0 ? (
                ...
                <div className="search-empty">
                  ...
                  <p className="search-suggestion">Try different search terms</p>
                </div>
              )
            ) : (
              <div className="search-help">
                <h3>Search Documentation</h3>
                <p>Enter a query to search across all components, design tokens, and documentation.</p>
                <div className="search-tips">
                  <h4>Search Tips</h4>
                  <ul>
                    <li>Use specific terms like "button", "color", or "grid"</li>
