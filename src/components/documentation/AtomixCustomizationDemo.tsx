...
const AtomixCustomizationDemo: React.FC = () => {
  ...
  return (
    <div style={{ padding: "2rem" }}>
      ...
      <p>
        This page demonstrates the enhanced styling of Atomix components with
        ...
        <GridCol md={6}>
          ...
          <Card className="u-mb-4">
            ...
            <div className="u-mb-3">
              <label htmlFor="demoInput" className="u-block u-mb-1">
                Input Field
              </label>
          ...
          items={[
            {
              ...
              content: (
                <div className="u-p-4">
                  <p>
                    Content for Tab One. Notice the enhanced styling of the
                    active tab.
                  </p>
                </div>
              ),
            },
            {
              ...
              content: (
                <div className="u-p-4">
                  <p>
                    Content for Tab Two. The tab navigation has been customized
            ...
            },
            {
              ...
              content: (
                <div className="u-p-4">
                  <p>
                    Content for Tab Three. All tabs have improved styling and
                    transitions.
                  </p>
                </div>
              ),
