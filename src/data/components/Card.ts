export const cardMetadata = {
  ...
  name: "Card",
  description:
    "A flexible container that displays content in a contained, structured format. Perfect for showcasing information, creating dashboards, product listings, and organizing content into digestible sections.",
  category: "Layout",
...
<Card
  className="c-card--glass"
  title="Glass Card"
  text="Beautiful frosted glass effect with subtle transparency."
/>`,
      preview: true,
    },
    {
      title: "Gradient Card",
      description: "Cards with gradient background",
      code: `import { Card } from '@shohojdhara/atomix';

<Card
  className="c-card--gradient"
  title="Gradient Card"
  text="Subtle gradient that intensifies on hover."
/>`,
      preview: true,
    },
    {
      title: "Stat Card",
      description: "Centered metrics card for displaying numbers",
      code: `import { Card, Icon } from '@shohojdhara/atomix';

<Card className="c-card--stat c-card--interactive">
  <Icon name="Users" className="c-card__icon" />
  <div className="c-card__title">2,847</div>
  <div className="c-card__text">Active Users</div>
</Card>`,
      preview: true,
    },
    {
      title: "Alert Cards",
      description: "Cards with colored left border for notifications",
      code: `import { Card } from '@shohojdhara/atomix';

<Card className="c-card--alert c-card--alert--success" title="Success" text="Operation completed successfully!" />

<Card className="c-card--alert c-card--alert--warning" title="Warning" text="Please review your settings." />

<Card className="c-card--alert c-card--alert--error" title="Error" text="Something went wrong." />

<Card className="c-card--alert c-card--alert--info" title="Info" text="New updates are available." />`,
      preview: true,
    },
    {
      title: "Dark Card",
      description: "Dark surface card for contrast sections",
      code: `import { Card } from '@shohojdhara/atomix';

<Card
  className="c-card--dark"
  title="Dark Card"
  text="Perfect for dark-themed sections or contrast layouts."
/>`,
      preview: true,
    },
    {
      title: "Floating Card",
      description: "Centered card with prominent shadow",
      code: `import { Card } from '@shohojdhara/atomix';

<Card
  className="c-card--floating c-card--interactive"
  title="Floating Card"
  text="Elevated card with strong shadow effect."
/>`,
      preview: true,
    },
    {
...
<Card
  className="c-card--compact"
  title="Compact Card"
  text="Smaller padding for space-constrained layouts."
/>`,
      preview: true,
    },
  ],
  accessibility: {
    overview:
      "The Card component follows accessibility best practices with proper ARIA attributes, keyboard navigation, and semantic HTML.",
    keyboardSupport: [
      {
        key: "Enter/Space",
        action: "Activates the card (when interactive)",
        context: "When onClick prop is provided",
      },
      {
        key: "Tab",
        action: "Moves focus to the card and interactive elements within",
        context: "When interactive",
      },
      {
        key: "Shift + Tab",
        action: "Moves focus away from the card",
        context: "When interactive",
      },
    ],
    ariaAttributes: [
      {
        attribute: "role",
        description:
          'Applied automatically: "button" when onClick is provided, "link" when href is provided, "article" for standalone content',
        required: false,
      },
      {
        attribute: "aria-label",
        description:
          "For cards without visible text or when additional context is needed",
        required: false,
      },
      {
        attribute: "aria-labelledby",
        description: "To associate card with its title",
        required: false,
      },
      {
        attribute: "aria-describedby",
        description: "To associate card with its description",
        required: false,
      },
      {
        attribute: "tabIndex",
        description: "Set appropriately for interactive cards",
        required: false,
      },
    ],
    guidelines: [
