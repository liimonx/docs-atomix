/**
 * Documentation content loader - simplified version without markdown loading.
 * Directly returns structured component data instead of parsing markdown files.
 */

import { ComponentDocumentation } from '../types';

/**
 * Mock data store containing all component documentation in structured format.
 * In a real implementation, this could be replaced with a database or API call.
 */
 ...
 * Returns the structured documentation object directly from the mock data store.
 */
