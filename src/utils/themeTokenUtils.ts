 ...
 */
export function formatTokenValue(value: string, type: string): string {
  return value.trim();
}
 ...
 */
export function exportAsCSS(lightTokens: Record<string, string>, darkTokens: Record<string, string>): string {
