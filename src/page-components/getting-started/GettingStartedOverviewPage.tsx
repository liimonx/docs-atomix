                  ...
                  <Row>
                    <GridCol md={4} className="u-mb-4">
                      <div className="u-bg-tertiary-subtle u-rounded u-overflow-hidden u-border u-border-subtle">
                        ...
                        <pre
                          className="u-m-0 u-p-4 u-text-sm u-text-primary-emphasis"
                          style={{
                    ...
                    <div className="u-flex u-gap-3">
                      ...
                      <div className="u-flex-grow-1">
                        ...
                        <div className="u-bg-tertiary-subtle u-rounded u-p-3 u-border u-border-subtle">
                          <pre
                            className="u-m-0 u-text-xs u-text-primary-emphasis"
                            style={{
                              fontFamily: "var(--atomix-font-family-mono)",
                            }}
                          >
                        ...
                        <Card className="u-h-100 u-cursor-pointer">
                          <div
                            ...
                            style={{
                              ...
                              borderRadius: "12px",
                              background:
                                "rgba(var(--atomix-primary-rgb), 0.15)",
                            }}
                          >
                            <Icon
                              name="BookOpen"
                        ...
                        <Card className="u-h-100 u-cursor-pointer">
                          <div
                            ...
                            style={{
                              ...
                              borderRadius: "12px",
                              background:
                                "rgba(var(--atomix-success-rgb), 0.15)",
                            }}
                          >
                            <Icon
                              name="Palette"
                        ...
                        <Card className="u-lh-100 u-cursor-pointer">
                          <div
                            ...
                            style={{
                              ...
                              borderRadius: "12px",
                              background:
                                "rgba(var(--atomix-warning-rgb), 0.15)",
                            }}
                          >
                            <Icon
                              name="Code"
