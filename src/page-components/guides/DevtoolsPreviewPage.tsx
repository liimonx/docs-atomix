          ...
          <GridCol md={12}>
            <Card className="u-p-6">
              ...
              <p className="u-text-secondary-emphasis u-mb-4">
                ...
                allows you to preview custom components.
              </p>
              ...
              <Callout variant="success" className="u-mb-4">
                <p className="u-text-sm u-m-0">
                  ...
                  — Customize colors and visualize a theme with sample
                  components.
                </p>
              </Callout>
              ...
              <ul className="u-ms-4 u-mb-4">
                ...
                <li className="u-mb-2">
                  <strong>Color Palette</strong> - Visual representation of all
                  theme colors
                </li>
                <li className="u-mb-2">
                  <strong>Typography Samples</strong> - Preview all font sizes,
                  weights, and line heights
                </li>
                <li className="u-mb-2">
                  <strong>Spacing Scale</strong> - Visualize spacing tokens
                </li>
                <li className="u-mb-2">
                  <strong>Custom Components</strong> - Test theme with your
                  actual components
                </li>
                <li className="u-mb-2">
                  <strong>Sample Rendering</strong> - Built-in sample components
                  for quick testing
                </li>
              </ul>
            </Card>
                ...
                <table className="u-w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="u-p-3">
                        Show color palette visualization
                      </td>
                    </tr>
                    <tr>
                      <td className="u-p-3">
                        <code>showTypography</code>
                      </td>
                      <td className="u-p-3">
                        <code>boolean</code>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="u-p-3">
                        Show spacing scale visualization
                      </td>
                    </tr>
                    <tr>
                      <td className="u-p-3">
                      ...
                      <td className="u-p-3">
                        Custom components to render with theme
                      </td>
                    </tr>
                    <tr>
                      <td className="u-p-3">
          ...
          <GridCol md={12}>
            <Card className="u-p-6">
              ...
              <Callout variant="success" className="u-mb-4">
                ...
                <p className="u-text-sm u-m-0">
                  Always preview themes with your actual application components,
                  not just the default samples. This ensures the theme works
                  correctly in your specific use cases.
                </p>
              </Callout>
              ...
              <Callout variant="info" className="u-mb-4">
                ...
                <p className="u-text-sm u-m-0">
                  Test all component variants (primary, secondary, outline,
                  etc.) to ensure consistent theming across your entire
                  component library.
                </p>
              </Callout>
              ...
              <Callout variant="warning" className="u-mb-4">
                ...
                <p className="u-text-sm u-m-0">
                  Use the color palette view to check contrast ratios. Ensure
                  text is readable against all background colors in your theme.
                </p>
              </Callout>
              ...
              <Callout variant="warning" className="u-mb-0">
                ...
                <p className="u-text-sm u-m-0">
                  CSS variables are generated once and cached for performance.
                  The preview updates smoothly even with complex themes.
                </p>
              </Callout>
            </Card>
          </GridCol>
