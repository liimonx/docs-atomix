                        ...
                        <Card className="u-p-6">
                            ...
                            <Callout variant="success" className="u-mb-4">
                                <p className="u-fs-sm u-m-0">
                                    ...
                                    {" "}— Analyze and validate a sample theme directly in your browser.
                                </p>
                            </Callout>

                            <h3 className="u-fs-lg u-fw-semibold u-mb-3">Key Features</h3>
                            <ul className="u-ml-4 u-mb-4">
                                <li className="u-mb-2"><strong>Theme Metadata</strong> - Display theme name, version, and statistics</li>
                                <li className="u-mb-2"><strong>Validation</strong> - Comprehensive error and warning reporting</li>
                                <li className="u-mb-2"><strong>Accessibility Checks</strong> - Contrast ratio analysis and WCAG compliance</li>
                                <li className="u-mb-2"><strong>CSS Variables Preview</strong> - See generated CSS custom properties</li>
                                <li className="u-mb-2"><strong>Structure Visualization</strong> - Interactive theme structure tree</li>
                            </ul>
                        </Card>
                    </GridCol>
                </Row>
                    ...
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Simple Inspector</h3>
                                <EnhancedCodeBlock
                                    language="tsx"
  ...
  return (
    ...
    />
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">With Custom Styling</h3>
                                <EnhancedCodeBlock
                                    language="tsx"
                                    code={`<ThemeInspector
  theme={theme}
                            ...
                            <div className="u-overflow-x-auto">
                                <table className="u-w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td className="u-p-3"><code>showValidation</code></td>
                                            <td className="u-p-3"><code>boolean</code></td>
                                            <td className="u-p-3"><code>false</code></td>
                                            <td className="u-p-3">Show validation results with errors and warnings</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>showCSSVariables</code></td>
                                            <td className="u-p-3"><code>boolean</code></td>
                                            <td className="u-p-3"><code>false</code></td>
                                            <td className="u-p-3">Show generated CSS custom properties</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>showStructure</code></td>
                                            <td className="u-p-3"><code>boolean</code></td>
                                            <td className="u-p-3"><code>false</code></td>
                                            <td className="u-p-3">Show theme structure tree visualization</td>
                                        </tr>
                                        <tr>
  ...
  return (
    <div className="dashboard">
      ...
      />
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Testing Integration</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
    ...
    expect(result.warnings).toContain(
      expect.objectContaining({
        ...
        message: expect.stringContaining('contrast'),
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Storybook Addon</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
    ...
    <div className="storybook-addon">
      ...
      />
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            <h2 className="u-fs-2xl u-fw-bold u-mb-4">Validation Features</h2>

                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">What Gets Validated</h3>
                                <ul className="u-ml-4 u-mb-4">
                                    <li className="u-mb-2"><strong>Required Properties</strong> - Ensures all required theme properties are present</li>
                                    <li className="u-mb-2"><strong>Type Checking</strong> - Validates property types and formats</li>
                                    <li className="u-mb-2"><strong>Color Formats</strong> - Checks for valid hex, RGB, or HSL colors</li>
                                    <li className="u-mb-2"><strong>Contrast Ratios</strong> - Analyzes text/background contrast for WCAG compliance</li>
                                    <li className="u-mb-2"><strong>Font Families</strong> - Validates font family declarations</li>
                                    <li className="u-mb-2"><strong>Spacing Values</strong> - Ensures valid spacing scale values</li>
                                </ul>

                                <Callout variant="info" className="u-mb-4">
                                    <p className="u-fs-sm u-m-0">
                                        <strong>Tip:</strong> Validation runs once on mount and is memoized for performance. Results are cached until the theme object changes.
                                    </p>
                                </Callout>
                            </div>

                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Error Levels</h3>
                                <div className="u-mb-3">
                                    <h4 className="u-fs-md u-fw-semibold u-mb-2">Errors (Red)</h4>
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <Callout variant="success" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Use During Development</h3>
                                <p className="u-fs-sm u-m-0">
                            ...
                            <Callout variant="info" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Check Accessibility</h3>
                                <p className="u-fs-sm u-m-0">
                            ...
                            <Callout variant="warning" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Review CSS Variables</h3>
                                <p className="u-fs-sm u-m-0">
                            ...
                            <Callout variant="error" className="u-mb-0">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Development Only</h3>
                                <p className="u-fs-sm u-m-0">
