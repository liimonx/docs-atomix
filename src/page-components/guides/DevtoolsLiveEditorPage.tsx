                    ...
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <ul className="u-ml-4 u-mb-4">
                                <li className="u-mb-2"><strong>Visual Editor</strong> - Edit common properties with color pickers and inputs</li>
                                <li className="u-mb-2"><strong>JSON Editor</strong> - Advanced editing with syntax highlighting and validation</li>
                                <li className="u-mb-2"><strong>Live Preview</strong> - Instant updates as you make changes</li>
                                <li className="u-mb-2"><strong>Export Theme</strong> - Download theme as JSON file</li>
                                <li className="u-mb-2"><strong>Copy to Clipboard</strong> - Copy theme JSON for quick integration</li>
                                <li className="u-mb-2"><strong>Syntax Validation</strong> - Real-time error checking</li>
                                <li className="u-mb-2"><strong>Debounced Updates</strong> - Smooth editing experience</li>
                            </ul>
                        </Card>
                    </GridCol>
                </Row>
                    ...
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Simple Editor</h3>
                                <EnhancedCodeBlock
                                    language="tsx"
  ...
  return (
    ...
    />
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">With State Management</h3>
                                <EnhancedCodeBlock
                                    language="tsx"
      ...
      <button onClick={() => saveTheme(theme)}>
        Save Theme
                        ...
                        <Card className="u-p-6">
                            ...
                            <div className="u-overflow-x-auto">
                                <table className="u-w-100">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td className="u-p-3"><code>initialTheme</code></td>
                                            <td className="u-p-3"><code>Theme</code></td>
                                            <td className="u-p-3">Required</td>
                                            <td className="u-p-3">Initial theme to edit</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>onChange</code></td>
                                            <td className="u-p-3"><code>(theme: Theme) =&gt; void</code></td>
                                            <td className="u-p-3">Required</td>
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            <h2 className="u-fs-2xl u-fw-bold u-mb-4">Editor Features</h2>

                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Visual Editor</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
                                    The visual editor provides intuitive controls for common theme properties:
                                </p>
                                <ul className="u-ml-4 u-mb-4">
                                    <li className="u-mb-2"><strong>Color Pickers</strong> - Visual color selection for palette colors</li>
                                    <li className="u-mb-2"><strong>Font Selectors</strong> - Choose from available font families</li>
                                    <li className="u-mb-2"><strong>Size Inputs</strong> - Adjust font sizes, spacing, and other numeric values</li>
                                    <li className="u-mb-2"><strong>Preset Options</strong> - Quick selection of common values</li>
                                </ul>
                            </div>

                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">JSON Editor</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
                                    For advanced editing, switch to JSON mode:
                                </p>
                                <ul className="u-ml-4 u-mb-4">
                                    <li className="u-mb-2"><strong>Syntax Highlighting</strong> - Color-coded JSON for readability</li>
                                    <li className="u-mb-2"><strong>Auto-completion</strong> - Suggestions for property names</li>
                                    <li className="u-mb-2"><strong>Error Detection</strong> - Real-time validation and error highlighting</li>
                                    <li className="u-mb-2"><strong>Format/Beautify</strong> - Auto-format JSON for consistency</li>
                                </ul>
                            </div>

                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Export Options</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
                                    Export your theme in multiple ways:
                                </p>
                                <ul className="u-ml-4 u-mb-4">
                                    <li className="u-mb-2"><strong>Download JSON</strong> - Save theme as a .json file</li>
                                    <li className="u-mb-2"><strong>Copy to Clipboard</strong> - Copy theme JSON for quick pasting</li>
                                    <li className="u-mb-2"><strong>Generate Code</strong> - Get createTheme() code snippet</li>
                                </ul>
                            </div>
                        </Card>
                    </GridCol>
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Theme Builder Application</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
    ...
    <div className="theme-builder">
      ...
      <div className="preview">
        <ThemePreview theme={theme} />
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Collaborative Editing</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
...
function CollaborativeThemeEditor({ roomId }) {
  ...
  return (
    ...
    />
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Undo/Redo Support</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
    ...
    <div>
      ...
      />
                    ...
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <Callout variant="success" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Start with Visual Editor</h3>
                            ...
                            <Callout variant="info" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Save Frequently</h3>
                                <p className="u-fs-sm u-m-0">
                            ...
                            <Callout variant="warning" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Validate Before Exporting</h3>
                                <p className="u-fs-sm u-m-0">
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            <h2 className="u-fs-2xl u-fw-bold u-mb-4">Keyboard Shortcuts</h2>

                            <div className="u-overflow-x-auto">
                                <table className="u-w-100">
                                    <thead>
                                        <tr>
                                            <th className="u-text-start u-p-3 u-bg-surface-subtle">Shortcut</th>
                                            <th className="u-text-start u-p-3 u-bg-surface-subtle">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td className="u-p-3"><code>Cmd/Ctrl + S</code></td>
                                            <td className="u-p-3">Export theme</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>Cmd/Ctrl + C</code></td>
                                            <td className="u-p-3">Copy theme JSON to clipboard</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>Cmd/Ctrl + F</code></td>
                                            <td className="u-p-3">Format JSON (in JSON mode)</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>Cmd/Ctrl + Z</code></td>
                                            <td className="u-p-3">Undo (if implemented)</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>Cmd/Ctrl + Shift + Z</code></td>
                    ...
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <div className="u-grid u-gap-3">
                                ...
                                <Link href="/docs/guides/theme-studio" className="u-text-primary u-fw-medium">
