                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            <h2 className="u-fs-2xl u-fw-bold u-mb-4">Installation</h2>

                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Global Installation</h3>
                                <EnhancedCodeBlock
                                    language="bash"
...
atomix-theme --version`}
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Project Installation</h3>
                                <EnhancedCodeBlock
                                    language="bash"
...
npx atomix-theme --help`}
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            <h2 className="u-fs-2xl u-fw-bold u-mb-4">Available Commands</h2>

                            <div className="u-overflow-x-auto">
                                <table className="u-w-100">
                                    <thead>
                                        <tr>
                                            <th className="u-text-start u-p-3 u-bg-surface-subtle">Command</th>
                                            <th className="u-text-start u-p-3 u-bg-surface-subtle">Description</th>
                                            <th className="u-text-start u-p-3 u-bg-surface-subtle">Options</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td className="u-p-3"><code>validate</code></td>
                                            <td className="u-p-3">Validate theme configuration</td>
                                            <td className="u-p-3"><code>--config</code>, <code>--strict</code></td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>list</code></td>
                                            <td className="u-p-3">List all available themes</td>
                                            <td className="u-p-3">-</td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>inspect</code></td>
                                            <td className="u-p-3">Inspect a specific theme</td>
                                            <td className="u-p-3"><code>--theme</code>, <code>--json</code></td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>compare</code></td>
                                            <td className="u-p-3">Compare two themes</td>
                                            <td className="u-p-3"><code>--theme1</code>, <code>--theme2</code></td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>export</code></td>
                                            <td className="u-p-3">Export theme to JSON</td>
                                            <td className="u-p-3"><code>--theme</code>, <code>--output</code></td>
                                        </tr>
                                        <tr>
                                            <td className="u-p-3"><code>help</code></td>
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            <h2 className="u-fs-2xl u-fw-bold u-mb-4">Command Examples</h2>

                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Validate Theme</h3>
...
atomix-theme validate --strict`}
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">List Themes</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
...
#   - custom (Custom Theme)`}
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Inspect Theme</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
...
atomix-theme inspect --theme light --json > theme-info.json`}
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Compare Themes</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
...
atomix-theme compare --theme1 light --theme2 dark --diff-only`}
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Export Theme</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
...
atomix-theme export --theme light --output ./light.json --pretty`}
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            <h2 className="u-fs-2xl u-fw-bold u-mb-4">CI/CD Integration</h2>

                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">GitHub Actions</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
...
jobs:
        ...
        run: |
          ...
          npx atomix-theme compare \\
            ...
            --theme2 ./themes/new.json`}
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">NPM Scripts</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
  ...
  "scripts": {
    ...
    "pretest": "npm run theme:validate"
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Pre-commit Hook</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <div className="u-mb-6">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Config File</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
    ...
    themes: {
      'my-theme': {
        ...
        version: '1.0.0',
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Environment Variables</h3>
                                <p className="u-text-secondary-emphasis u-mb-3">
                ...
                <Row className="u-mt-8">
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <div className="u-mb-4">
                                <h3 className="u-fs-lg u-fw-semibold u-mb-3">Common Issues</h3>

                                <div className="u-mb-4">
                                    <h4 className="u-fs-md u-fw-semibold u-mb-2">Command Not Found</h4>
...
npm install -g @shohojdhara/atomix`}
                                ...
                                <div className="u-mb-4">
                                    <h4 className="u-fs-md u-fw-semibold u-mb-2">Config File Not Found</h4>
                                    <p className="u-fs-sm u-text-secondary-emphasis u-mb-2">
...
atomix-theme validate --config ./path/to/config.ts`}
                                ...
                                <div>
                                    <h4 className="u-fs-md u-fw-semibold u-mb-2">Validation Errors</h4>
                                    <p className="u-fs-sm u-text-secondary-emphasis u-mb-2">
                    ...
                    <GridCol md={12}>
                        <Card className="u-p-6">
                            ...
                            <Callout variant="success" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Automate Validation</h3>
                                <p className="u-fs-sm u-m-0">
                            ...
                            <Callout variant="info" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Use Strict Mode</h3>
                                <p className="u-fs-sm u-m-0">
                            ...
                            <Callout variant="warning" className="u-mb-4">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Version Control Themes</h3>
                                <p className="u-fs-sm u-m-0">
                            ...
                            <Callout variant="warning" className="u-mb-0">
                                <h3 className="u-fs-md u-fw-semibold u-mb-2">Document Breaking Changes</h3>
                                <p className="u-fs-sm u-m-0">
